...
assert.strictEqual(program.description(), 'Kiro IDE .kiro directory browser and editor', 'Program description should match');
...
assert.ok(helpText.includes('Kiro IDE .kiro directory browser and editor'), 'Help text should contain description');
